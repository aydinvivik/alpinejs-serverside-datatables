  ...
  return {
    ...
    getData: function getData(_ref) {
      var page = _ref.page,
          limit = _ref.limit,
          query = _ref.query,
          sortingProp = _ref.sortingProp,
          sortingOrder = _ref.sortingOrder,
          search = _ref.search;
      var parameters = {
        _page: page,
        _limit: limit,
      ...
      return _axios.default.get('http://localhost:9993/users', {
        params: parameters
      }).then(function (_ref2) {
        var data = _ref2.data;
        return data;
    ...
    getTableData: function getTableData(page, limit) {
      var _this = this;

      return _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var reqPage, reqLimit, response;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this.loading = true;
                reqPage = page || _this.currentPage;
                reqLimit = limit || _this.pageSize;
                _context.prev = 3;
                _context.next = 6;
                return _this.getData({
                  page: reqPage,
                  limit: reqLimit,
                  sortingProp: _this.sortingProp,
                  sortingOrder: _this.sortingOrder,
                  search: _this.searchFilter
                });
              ...
              case 6:
                ...
                _this.totalCount = _this.total;
                _this.pagination.pageCount = _this.internalPageCount;
    ...
    toggleOrder: function toggleOrder(_ref3) {
      var order = _ref3.order;
      if (order === '') return this.sortOrders[0];
      var index = this.sortOrders.indexOf(order || null);
      return this.sortOrders[index > this.sortOrders.length - 2 ? 0 : index + 1];
    },
    handleHeaderClick: function handleHeaderClick(event, column, rowIndex, givenOrder) {
      ...
      var sortOrder;
      var unsortingColumns = this.headings.filter(function (x) {
        return x !== column;
      });
      var sortingColumn = unsortingColumns.forEach(function (column) {
        column.order = null;
      });
    ...
    handleSorting: function handleSorting(_ref4) {
      var key = _ref4.key,
          order = _ref4.order;
    ...
    getHeaderClass: function getHeaderClass(event, column) {
      var classes = [column.key, column.order];
    ...
    search: function search(event) {
      ...
      var keyCodes = [9, 13, 16, 17, 18, 20, 37, 38, 39, 40, 91, 116, 224];
    ...
    emitChange: function emitChange() {
      ...
      this.$nextTick(function () {
        if (_this3.pagination.internalCurrentPage !== _this3.pagination.lastEmittedPage || _this3.pagination.internalPageSize) {
          _this3.getValidCurrentPage(_this3.pagination.internalCurrentPage);

          _this3.pagination.lastEmittedPage = _this3.pagination.internalCurrentPage;
    ...
    pagers: function pagers() {
      var pagerCount = this.pagination.pagerCount;
      var halfPagerCount = (pagerCount - 1) / 2;
      var currentPage = Number(this.currentPage);
      var pageCount = Number(this.pagination.pageCount);
    ...
    setInternalPageCount: function setInternalPageCount(newVal) {
      var oldPage = this.pagination.internalCurrentPage;
    ...
    selectAllCheckbox: function selectAllCheckbox(e) {
      var _this4 = this;

      var columns = document.querySelectorAll('.rowCheckbox');
      this.selectedRows = [];
      ...
      if (e.target.checked == true) {
        columns.forEach(function (column) {
          ...
          _this4.selectedRows.push(column.name);
        });
      } else {
        columns.forEach(function (column) {
    ...
    getRowDetail: function getRowDetail(e, item) {
    ...
    toggleColumn: function toggleColumn(key) {
      var columns = document.querySelectorAll('.' + key);
    ...
    watchers: function watchers() {
      ...
      this.getTableData();
      this.$watch('currentPage', function (value) {
        _this5.internalCurrentPage = _this5.getValidCurrentPage(value);
        _this5.page = _this5.internalCurrentPage;
      });
      this.$watch('pageSize', function (value) {
        _this5.pagination.internalPageSize = isNaN(value) ? 10 : value;
      });
      this.$watch('pagination.internalCurrentPage', function (value) {
        _this5.currentPage = value;
        _this5.pagination.lastEmittedPage = -1;
      });
    }
  };
};
},{"alpinejs":"../node_modules/alpinejs/dist/alpine.js","axios":"../node_modules/axios/index.js","regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
